...
const LinksComponent = () => {
  return (
    <div className='flex flex-col'>
      <p className="text-white text-[16px] md:text-[21px] pt-[14px] mt-[10px] font-normal">
        🍹<span className="underline text-nowrap">Attend 390 meetups/year</span>&nbsp; in 100+ cities.
      </p>
      <p className="text-white text-[16px] md:text-[21px] pt-[14px]  font-normal">
        ❤️<span className="underline text-nowrap" >Meet new people</span>&nbsp; for dating or making friends.
      </p>
      <p className="text-white hidden md:block text-[16px] md:text-[21px] pt-[14px]  font-normal">
      ...
      <p className="text-white hidden md:block text-[16px] md:text-[21px] pt-[14px] justify-start  font-normal">
