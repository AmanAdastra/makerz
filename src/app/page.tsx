          ...
          <div className=" h-full w-full">
            <div className="relative flex items-center justify-between">
              ...
              <div className="relative h-[320px] w-[350px] bg-white rounded-lg p-6">
                ...
                <input placeholder="Type your email..." type="text" className="text-[16px] my-2 border-2 border-gray-200 w-full rounded-lg placeholder:text-black placeholder:font-light placeholder:text-[16px] p-2" />
